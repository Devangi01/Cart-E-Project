...
export default function Cartlist() {
  ...
  const handleChange = (event) => {
    ...
    setMainState({
      ...mainState,
      address: { ...mainState.address, id: uuid(), [event.target.name]: event.target.value },
    });
  };
  const saveAddress = () => {
    ...
    if (buttonType === 'Edit') {
      ...
      setMainState({
        ...
        address: {
          ...
          addDetails: tempData[0].addDetails,
        },
      });
    } else {
                ...
                >
                        ...
                        <TableBody>
                          {mainState.cartlist.map((row) => (
                            <TableRow key={row._id} sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                              ...
                              <TableCell align="center">{Number(row.price) * Number(row.qty)}</TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                      </Table>
                  ...
                  <Grid container style={{ padding: '5px' }} spacing={2}>
                    ...
                    <Grid item xs={7}>
                      <Grid container>
                        <Grid item xs={5}>
                          <Typography sx={{ mt: 0.4, mr: 0.2 }}>Sub Total</Typography>
                        </Grid>
                        <Grid item xs={7}>
                          <TextField
                            id="outlined-basic"
                        ...
                        <Grid item xs={5}>
                          <Typography sx={{ mt: 0.4, mr: 0.2 }}>Tax</Typography>
                        </Grid>
                        <Grid item xs={7}>
                          <TextField
                            id="outlined-basic"
                        ...
                        <Grid item xs={5}>
                          <Typography sx={{ mt: 0.4, mr: 0.2 }}>Total</Typography>
                        </Grid>
                        <Grid item xs={7}>
                          <TextField
                            id="outlined-basic"
                      ...
                      <Button sx={{ mt: 2 }} onClick={handleOpen} variant="outlined">
                        Process To Checkout
                      </Button>
                    </Grid>
                  </Grid>
                            ...
                            <FormControlLabel
                              ...
                              label={
                                ...
                                >
                                  ...
                                  >
                                    <Typography>{data.addDetails}</Typography>
                                  </Box>
                                  <Stack
                                    direction="row"
                                    spacing={1}
                                  ...
                                  >
                                    <Stack>
                                      <Button
                                        size="small"
                                        variant="outlined"
                                        onClick={() => handleEditDeleteButton(data.id, 'Edit')}
                                        color="primary"
                                      >
                                    ...
                                    <Stack>
                                      <Button
                                        size="small"
                                        variant="outlined"
                                        onClick={() => handleEditDeleteButton(data.id, 'Delete')}
                                        color="error"
                                      >
